(function (global, factory) {
    ...
    var defaults = _objectSpread2(
        ...
        {},
        {
            ...
            itemBackgroundColor:
                Chart.defaults.global.elements.rectangle.backgroundColor,
            itemBorderColor:
                Chart.defaults.global.elements.rectangle.borderColor,
            hitPadding: 2,
            outlierHitRadius: 4,
            tooltipDecimals: 2,
        }
    ...
    var ArrayElementBase = Chart.Element.extend({
        ...
        tooltipPosition: function tooltipPosition(eventPosition, tooltip) {
            ...
            var index = this._outlierIndexInRange(
                eventPosition.x,
                eventPosition.y
            );
    ...
    Chart.defaults.global.elements.boxandwhiskers = _objectSpread2(
        {},
        defaults
    );
    ...
    var BoxAndWiskers = (Chart.elements.BoxAndWhiskers = ArrayElementBase.extend(
        {
            ...
            _getOutliers: function _getOutliers() {
                return this._view.boxplot
                    ? this._view.boxplot.outliers || []
                    : [];
            },
        }
    ));
    ...
    function boxplotTooltip(item, data) {
        ...
        return label.apply(
            this,
            [item, data, b, hoveredOutlierIndex].concat(args)
        );
    }
            ...
            _updateElementGeometry: function _updateElementGeometry(
                ...
                (_Chart$controllers$ba =
                    Chart.controllers.bar.prototype
                        ._updateElementGeometry).call.apply(
                    _Chart$controllers$ba,
    ...
    var BoxPlot = (Chart.controllers.boxplot = Chart.controllers.bar.extend(
        boxplot
    ));
    var HorizontalBoxPlot = (Chart.controllers.horizontalBoxplot = Chart.controllers.horizontalBar.extend(
        boxplot
    ));
        ...
        tooltips: {
            callbacks: {
                ...
                violinLabel: function violinLabel(item, data) {
                    ...
                    return ""
                        .concat(label, " (")
                        .concat(toFixed.call(this, value), ")");
                },
            },
        },
    };
    ...
    var Violin$1 = (Chart.controllers.violin = Chart.controllers.bar.extend(
        controller
    ));
    var HorizontalViolin = (Chart.controllers.horizontalViolin = Chart.controllers.horizontalBar.extend(
        controller
    ));
            ...
            determineDataLimits: function determineDataLimits() {
                ...
                if (this.min === this.max) {
                    if (this.min !== 0 && this.min !== null) {
                        this.min = Math.pow(
                            10,
                            Math.floor(helpers$1.log10(this.min)) - 1
                        );
                        this.max = Math.pow(
                            10,
                            Math.floor(helpers$1.log10(this.max)) + 1
                        );
                    } else {
                        this.min = 1;
                        this.max = 10;
    ...
    exports.getStats = asBoxPlotStats;
