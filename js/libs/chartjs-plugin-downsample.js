            ...
            function (require, module, exports) {
                ...
                function downsample(data, threshold) {
                    ...
                    for (var i = 0; i < threshold - 2; i++) {
                        ...
                        avgRangeEnd =
                            avgRangeEnd < dataLength ? avgRangeEnd : dataLength;
                        ...
                        for (; rangeOffs < rangeTo; rangeOffs++) {
                            ...
                            area =
                                abs(
                                    (pointAX - avgX) *
                                        (data[rangeOffs].y - pointAY) -
                                        (pointAX - data[rangeOffs].x) *
                                            (avgY - pointAY)
                                ) * 0.5;
                            if (area > maxArea) {
                                maxArea = area;
                ...
                function getFilteredDatasets(chartInstance) {
                    var targetDatasets = getOptions(chartInstance)
                        .targetDatasets;
                ...
                var downsamplePlugin = {
                    beforeInit: function (chartInstance) {
                        var options = (chartInstance.options.downsample = helpers.extend(
                            {},
                            defaultOptions,
